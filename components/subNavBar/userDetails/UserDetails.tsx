...
const UserDetails = () => {
  return (
    <div className="min-h-[100vh]">
      <div className="flex items-center bg-[#F4EEE6] py-5 mt-2 rounded-t-card md:mt-0 md:rounded-none px-4 lg:px-6">
        <button
          aria-label="Go back"
        ...
        <div className="grow text-primary-700">
          <h1 className="font-condensed text-[34px] text-h-l-mobile hidden lg:block">
            Suyash
          </h1>
        </div>
      </div>
