...
const BackButton = () => {
  ...
  return (
    <div className="absolute inset-x-4 top-0 py-4 flex items-start bg-neutral-50 lg:inset-x-10 lg:flex-row-reverse z-40">
      <div className="flex grow items-center lg:hidden">
        <button
          aria-label="Go back to main thread"
          ...
          type="button"
          onClick={() => setAppData({ ...appData, hideGalleryOnMobile: false })}
        >
          <svg
            viewBox="0 0 24 24"
            fill="none"
        ...
        <span className="t-action-m grow pr-9 text-center text-primary-700">
          New thread
        </span>
      </div>
    </div>
