...
const SideNav = () => {
  ...
  return (
    <div className="w-22 hidden flex-col items-center gap-1 border-r p-3 pt-5 lg:flex bg-[#F9F3EB] border-[#EBE1D3]">
      {paths.map((path: { icon: any; text: string; path: string }) => (
        <NavIcon
          key={path.path}
          activePath={pathname.includes(path.path)}
          path={path.path}
          text={path.text}
          icon={path.icon}
        />
